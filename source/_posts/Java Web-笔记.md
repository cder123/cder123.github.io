...
public final class MailUtils {
    ...
    // 使用前，先登录邮箱，并开启邮箱的s
    private static final String USER = "12345@qq.com"; // 发件人称号，同邮箱地址
    private static final String PASSWORD = "abcde"; // 如果是qq邮箱可以使户端授权码，或者登录密码
    ...
    public static void main(String[] args) throws Exception { // 做测试用
        MailUtils.sendMail("23456@qq.com","你好，这是一封测试邮件，无需回复。","测试邮件");
